      ...
      elements: [
        {
          ...
          children: [
            { id: "status-bar", type: "mobile-status-bar", props: {} },
            { id: "title", type: "text", props: { text: "Skills", fontSize: 28, fontWeight: 700, color: "#000" } },
            { id: "nav-bar", type: "mobile-nav-bar", props: { tabs: ["All", "Productivity", "Developer", "Creative"], activeTab: 0 } },
          ],
        },
      ],
    },
      ...
      elements: [
        {
          ...
          children: [
            { id: "status-bar-2", type: "mobile-status-bar", props: {} },
          ],
        },
      ],
    },
