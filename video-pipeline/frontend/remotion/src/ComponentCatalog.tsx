...
const sampleProps: Record<string, Record<string, unknown>> = {
  ...
  "cover-card": {},
  "generating-pill": {},
  "mobile-list-item": { icon: "🐛", title: "Bug Fixer", subtitle: "Fixes code issues", iconBg: "#E8F2FF" },
  "mobile-nav-bar": { tabs: ["All", "Productivity"], activeTab: 0 },
  "mobile-status-bar": {},
  "lower-third": { name: "Jane Smith", subtitle: "CEO, Acme Corp", position: "bottom-left" },
  "geometric-card": { name: "Demo User", role: "Tester", text: "Looks great!", theme: "blue" },
  "minimal-card": { children: null },
  "mock-ui-card": { children: null, type: "chat", elevation: 1 },
  "animated-counter": { target: 12847, prefix: "", suffix: " steps" },
...
const layerOf = (name: string): string => {
  const layout = ["browser-mockup", "center-layout", "coverflow-carousel", "floating-card", "horizontal-carousel", "icon-grid", "device-frame", "layered-element", "pop-up-book-base", "pricing-stack", "split-layout", "split-media"];
