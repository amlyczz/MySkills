...
export const componentRegistry: Record<string, React.FC<any>> = {
  ...
  "filter-pills": FilterPills, "cover-card": FlowMusicCard, "generating-pill": GeneratingPill,
  "gradient-text": GradientText, "mobile-list-item": IOSListItem, "mobile-nav-bar": IOSNavBar,
  "mobile-status-bar": IOSStatusBar, "key-point": KeyPoint, "lower-third": LowerThird,
  "luxury-card": LuxuryCard, "geometric-card": MemphisCard, "minimal-card": MinimalCard,
  "mock-ui-card": MockUICard, "animated-counter": AnimatedCounter, "pricing-card": PricingCard,
  ...
  "chip-card": ChipCard, "branch-flow": BranchFlow,
  // ── Layout ──
  ...
  "device-frame": IPhoneFrame, "layered-element": LayeredElement,
  ...
  "radial-glow": RadialGlow, "particle-field": ParticleField,
  "icon-badge": IconBadge,
  // ── Glassmorphism atoms ──
  "blur-fade-text": BlurFadeText, "glass-card": GlassUIWindow,
  "glow-bar-chart": GlowBarChart, "typing-message": TypingMessage,
  "canvas-gradient-bg": FluidMeshGradient,
};
