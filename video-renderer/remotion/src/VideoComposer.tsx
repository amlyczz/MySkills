...
export const VideoComposer: React.FC<VideoComposerProps> = ({ config }) => {
  ...
  // ── BGM volume curve ──
  // Prefer pre-computed curve from video_config.json (generated by
  // timeline_composer.py to eliminate duplicate bgmCurve logic).
  // Fall back to runtime generation for the matching.ts path.
  const bgmCurve = config.audio.bgm?.volumeCurve
    ? config.audio.bgm.volumeCurve
