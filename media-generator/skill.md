...
音频产物输出到统一目录 `output/{source_category}/{YYYY-MM-DD-HHMM}/{repo_name}/`：
...
```python
from media_generator.capabilities import (
...
```python
from media_generator.providers.base import BaseProvider, GenerationResult
